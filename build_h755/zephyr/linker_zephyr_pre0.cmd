...
renesas_elc_driver_api_area : SUBALIGN(4) { _renesas_elc_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._renesas_elc_driver_api.static.*))); _renesas_elc_driver_api_list_end = .;; } > FLASH
...
_nocache_load_start = LOADADDR(nocache);
